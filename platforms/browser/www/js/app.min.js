...
"use strict";var initUnidades=function(){return $("header.cabecalho").fadeIn(),$(".selecionador").fadeIn(),initSliders(),loadSubMenu("unidades.html",function(){$(".gallMemorial").on("click",startMemorial)}),!0},startMemorial=function(){lightGallery(document.querySelector(".gallMemorial"),{dynamic:!0,download:!1,dynamicEl:allPltsGalleries["gall-memorial"]})},getPlts=function(s){var a=$(s).attr("data-url"),i=a.split(".")[0],t="bay-01.html"==a||"beach-02.html"==a,e=!1;getSetHtml("#pltsArea","paginas/plantas/"+a,function(){t&&(e=Array.from($("#pltsArea .item")).map(function(s){return $(s).attr("id")}),initSliders()),$("#pltsArea").children().css("opacity",0),$("#pltsArea").show().addClass("zoomIn animated"),setTimeout(function(){$("#pltsArea").children().css("opacity",1);var s=0;appInCell||(s=50),$(".pinArea").css("height",parseInt($(".plts img").height()-s)+"px");var a=$("#pltsArea").width()/2;console.log(a),$("#pltsArea").css("left","calc(50% - "+a+"px)"),setTimeout(function(){t?e.forEach(function(s){$("#"+s+" .pinArea li").fadeIn()}):$(".pinArea li").fadeIn()},200)},600),setTimeout(function(){$("#pltsArea").removeClass("zoomIn animated"),t?e.forEach(function(s){renderPltToolbar("gal-"+i,s)}):renderPltToolbar("gal-"+i)},400)})},showHideDiferenc=function(s){var a=1<arguments.length&&void 0!==arguments[1]&&arguments[1],i=a?a+" ":"";$(i+".pinArea li i").removeClass("sel");var t=$(i+".pinArea li").index(s),e=$(i+".diferenciais > li")[t];$(s).children().addClass("sel"),$(i+"ul.diferenciais li.difItems").hide(),setTimeout(function(){$(e).show().addClass("fadeIn animated")},100)},getDinamicGallery=function(s,e){[e+"."+s,e+"."+s+"-zoom"].forEach(function(t,s){$(t).on("click",function(){var s=void 0;if(e){var a=$(t).attr("data-indGall")?$(t).attr("data-indGall"):"";s=t.split(" ")[1]+a}else s=t;var i=allPltsGalleries[s.replace(".","")];lightGallery(document.querySelector(t),{dynamic:!0,download:!1,dynamicEl:i})})})},renderPltToolbar=function(s,a){var i=a?"#"+a+" ":"";$(i+".closePlt").on("click",function(){$("#pltsArea").addClass("zoomOut animated"),setTimeout(function(){$("#pltsArea").hide(),$("#pltsArea").removeClass("zoomOut animated")},400)}),$(i+".pinArea li").on("click",function(){showHideDiferenc(this,i)}),getDinamicGallery(s,i)},startButtonsTowers=function a(i){var s=$("#navPlants ul li i.fa-minus-circle").parent().attr("id")==$(i).attr("id");$("#navPlants ul li i").removeClass("fa-minus-circle").addClass("fa-plus-circle");var t=0;if($(".menuPlants:visible").length&&($(".menuPlants").addClass("fadeOut animated"),setTimeout(function(){$(".menuPlants").hide()},200),setTimeout(function(){$(".menuPlants").removeClass("fadeOut animated")},300),$("body").off("click",a),t=300),!$(i).attr("id"))return $("#navPlants ul li i").removeClass("fa-minus-circle").addClass("fa-plus-circle"),void $("body").off("click",a);s||setTimeout(function(){$(i).children("i").removeClass("fa-plus-circle").addClass("fa-minus-circle");var s="zoomInUp animated";switch($(i).attr("id")){case"hill":$("#menuHill").show().addClass(s),setTimeout(function(){$("#menuHill").removeClass(s)},300);break;case"bay":$("#menuBay").show().addClass(s),setTimeout(function(){$("#menuBay").removeClass(s)},300);break;case"beach":$("#menuBeach").show().addClass(s),setTimeout(function(){$("#menuBeach").removeClass(s)},300);break;case"park":$("#menuPark").show().addClass(s),setTimeout(function(){$("#menuPark").removeClass(s)},300)}setTimeout(function(){$("body").on("click",a)},300)},t)},allPltsGalleries={"gal-hill-01":[{src:"imgs/perspectivas/aptos/HILL_601_LIVING.jpg",thumb:"imgs/perspectivas/aptos/HILL_601_LIVING.jpg",subHtml:"<h4>ILUSTRAÇÃO ARTÍSTICA DO LIVING DA UNIDADE 601 DO HILL</h4>"},{src:"imgs/perspectivas/aptos/HILL_601_SUITE.jpg",thumb:"imgs/perspectivas/aptos/HILL_601_SUITE.jpg",subHtml:"<h4>ILUSTRAÇÃO ARTÍSTICA DA SUÍTE MASTER DA UNIDADE 601 DO HILL</h4>"}],"gal-hill-01-zoom":[{src:"imgs/plantas/zoom/HILL-101-A-1701.jpg",thumb:"imgs/perspectivas/47-Vista-Piscina.jpg",subHtml:"<h4></h4>"}],"gal-hill-02":[{src:"imgs/perspectivas/aptos/hill-1002-suite-master.jpg",thumb:"imgs/perspectivas/aptos/hill-1002-suite-master.jpg",subHtml:"<h4>ILUSTRAÇÃO ARTÍSTICA DA SUÍTE MASTER DA UNIDADE 1002 DO HILL</h4>"}],"gal-hill-02-zoom":[{src:"imgs/plantas/zoom/HILL-102-A-1702.jpg",thumb:"imgs/perspectivas/44-Piscina-Raia.jpg",subHtml:"<h4></h4>"}],"gal-bay-01":[{src:"imgs/perspectivas/aptos/BAY_1201_LIVING.jpg",thumb:"imgs/perspectivas/aptos/BAY_1201_LIVING.jpg",subHtml:"<h4>ILUSTRAÇÃO ARTÍSTICA DO LIVING DA UNIDADE 1201 DO BAY</h4>"},{src:"imgs/perspectivas/aptos/BAY_1201_SUITE.jpg",thumb:"imgs/perspectivas/aptos/BAY_1201_SUITE.jpg",subHtml:"<h4>ILUSTRAÇÃO ARTÍSTICA DA SUÍTE MASTER DA UNIDADE 1201 DO BLOCO BAY</h4>"}],"gal-bay-01-zoom":[{src:"imgs/plantas/zoom/BAY-401-A-1801.jpg",thumb:"imgs/perspectivas/44-Piscina-Raia.jpg",subHtml:"<h4></h4>"}],"gal-bay-01_1":[{src:"imgs/perspectivas/aptos/BAY_1901_TERRACO.jpg",thumb:"imgs/perspectivas/aptos/BAY_1901_TERRACO.jpg",subHtml:"<h4>ILUSTRAÇÃO ARTÍSTICA DO TERRAÇO DA UNIDADE 1901 DO BAY</h4>"}],"gal-bay-01-zoom_1":[{src:"imgs/plantas/zoom/BAY-1901.jpg",thumb:"imgs/perspectivas/44-Piscina-Raia.jpg",subHtml:"<h4></h4>"}],"gal-bay-01_2":[],"gal-bay-01-zoom_2":[{src:"imgs/plantas/zoom/BAY-2001-A-2301.jpg",thumb:"imgs/perspectivas/44-Piscina-Raia.jpg",subHtml:"<h4></h4>"}],"gal-bay-02":[{src:"imgs/perspectivas/aptos/Bay_Suite_602.jpg",thumb:"imgs/perspectivas/aptos/Bay_Suite_602.jpg",subHtml:"<h4>ILUSTRAÇÃO ARTÍSTICA DA SUÍTE DA UNIDADE 602 DO BAY</h4>"}],"gal-bay-02-zoom":[{src:"imgs/plantas/zoom/BAY-402-A-2302.jpg.jpg",thumb:"imgs/perspectivas/44-Piscina-Raia.jpg",subHtml:"<h4></h4>"}],"gal-beach-01":[{src:"imgs/perspectivas/aptos/BEACH_601_LIVING.jpg",thumb:"imgs/perspectivas/aptos/BEACH_601_LIVING.jpg",subHtml:"<h4>ILUSTRAÇÃO ARTÍSTICA DO LIVING DA UNIDADE 601 DO BEACH</h4>"},{src:"imgs/perspectivas/aptos/BEACH_601_SUITE.jpg",thumb:"imgs/perspectivas/aptos/BEACH_601_SUITE.jpg",subHtml:"<h4>ILUSTRAÇÃO ARTÍSTICA DA SUÍTE MASTER DA UNIDADE 601 DO BEACH </h4>"}],"gal-beach-01-zoom":[{src:"imgs/plantas/zoom/BEACH-401-A-2301.jpg",thumb:"imgs/perspectivas/44-Piscina-Raia.jpg",subHtml:"<h4></h4>"}],"gal-park-01":[{src:"imgs/perspectivas/aptos/park-601-living.jpg",thumb:"imgs/perspectivas/aptos/park-601-living.jpg",subHtml:"<h4>ILUSTRAÇÃO ARTÍSTICA DO LIVING DA UNIDADE 601 DO PARK</h4>"},{src:"imgs/perspectivas/aptos/park-601-suite-.jpg",thumb:"imgs/perspectivas/aptos/park-601-suite-.jpg",subHtml:"<h4>ILUSTRAÇÃO ARTÍSTICA DA SUÍTE DA UNIDADE 601 DO PARK</h4>"}],"gal-park-01-zoom":[{src:"imgs/plantas/zoom/PARK-101-A-1701.jpg",thumb:"imgs/perspectivas/44-Piscina-Raia.jpg",subHtml:"<h4></h4>"}],"gal-park-02":[{src:"imgs/perspectivas/aptos/park-1002-suite-master.jpg",thumb:"imgs/perspectivas/aptos/park-1002-suite-master.jpg",subHtml:"<h4>ILUSTRAÇÃO ARTÍSTICA DA SUÍTE MASTER DA UNIDADE 1002 DO PARK</h4>"}],"gal-park-02-zoom":[{src:"imgs/plantas/zoom/PARK-102-A-1702.jpg",thumb:"imgs/perspectivas/44-Piscina-Raia.jpg",subHtml:"<h4></h4>"}],"gal-beach-02":[],"gal-beach-02-zoom":[{src:"imgs/plantas/zoom/BEACH-402-A-1802.jpg",thumb:"imgs/perspectivas/44-Piscina-Raia.jpg",subHtml:"<h4></h4>"}],"gal-beach-02_1":[{src:"imgs/perspectivas/aptos/BEACH_1902_TERRACO.jpg",thumb:"imgs/perspectivas/aptos/BEACH_1902_TERRACO.jpg",subHtml:"<h4>ILUSTRAÇÃO ARTÍSTICA DO TERRAÇO DA UNIDADE 1902 DO BEACH </h4>"}],"gal-beach-02-zoom_1":[{src:"imgs/plantas/zoom/BEACH-1902.jpg",thumb:"imgs/perspectivas/44-Piscina-Raia.jpg",subHtml:"<h4></h4>"}],"gal-beach-02_2":[{src:"imgs/perspectivas/aptos/BEACH_601_LIVING.jpg",thumb:"imgs/perspectivas/aptos/BEACH_601_LIVING.jpg",subHtml:"<h4></h4>"},{src:"imgs/perspectivas/aptos/BEACH_1902_TERRACO.jpg",thumb:"imgs/perspectivas/aptos/BEACH_1902_TERRACO.jpg",subHtml:"<h4></h4>"}],"gal-beach-02-zoom_2":[{src:"imgs/plantas/zoom/BEACH-2002-A-2302.jpg",thumb:"imgs/perspectivas/44-Piscina-Raia.jpg",subHtml:"<h4></h4>"}],"gall-memorial":[{src:"imgs/desk/Memorial-1.jpg",thumb:"imgs/desk/Memorial-1.jpg",subHtml:"<h4></h4>"},{src:"imgs/desk/Memorial-2.jpg",thumb:"imgs/desk/Memorial-2.jpg",subHtml:"<h4></h4>"},{src:"imgs/desk/Memorial-3.jpg",thumb:"imgs/desk/Memorial-3.jpg",subHtml:"<h4></h4>"},{src:"imgs/desk/Memorial-4.jpg",thumb:"imgs/desk/Memorial-4.jpg",subHtml:"<h4></h4>"},{src:"imgs/desk/Memorial-5.jpg",thumb:"imgs/desk/Memorial-5.jpg",subHtml:"<h4></h4>"}]};
