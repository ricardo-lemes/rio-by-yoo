...
"use strict";window.addEventListener("orientationchange",function(){90==window.orientation||window.orientation});var appInCell=void 0,locHash=void 0;!function(){function n(e,t){locHash=$("nav.menu a.selecionado").length?$("nav.menu a.selecionado").attr("nav-link"):"paginas/home.html";var s=e,r=$(".conteudo"),n=s,l=s.split("/").pop().split(".")[0];appInCell&&(l=l.split("-mob")[0]),"home"==l||"cyrela"==l?($(".chapterMenu").hide(),$(".navArrows").hide()):($(".chapterMenu").show(),$(".navArrows").show(),$(".fa-angle-left").hide(),"yoo"==l||"regiao"==l?$("#submenuArea").addClass("mini"):$("#submenuArea").removeClass("mini")),$.ajax(n).done(function(e){var n,i,a,o={home:initHome,unidades:initUnidades,projeto:initProjeto,yoo:initYoo,cyrela:initCyrela,regiao:initRegiao};$(".owl-dots").fadeOut().remove(),n=r,i=e,a=o[l],$(n).css("overflow","hidden"),$(n).addClass("bounceOutRight animated"),setTimeout(function(){$(n).hide(),$(n).removeClass("bounceOutRight animated")},400),setTimeout(function(){$(n).html(i).promise().done(a).promise().done(function(){setTimeout(function(){$(n).show(),$(n).addClass("bounceInRight animated"),0<=i.indexOf('id="home"')?$(".owl-dots").hide():($(".owl-dots").appendTo(".fixArea"),$(".owl-dots").addClass("my-main-owl").show())},200)})},800),function(e){Array.from($("a.home, nav.menu a")).forEach(function(e){if($(e).hasClass("selecionado")){var n=$(e).children().children().attr("src").replace("ico-sel.png","ico.png");$(e).children().children().attr("src",n)}e.classList.remove("selecionado")}),appInCell&&(e=e.split("-mob").join([""]));var n=document.querySelector("a[nav-link='"+e+"']"),i=$("body").width()<768?-2:5;console.log(i);var a=parseInt($(n).position().left)+i+parseInt($(n).width()/2);if(!$(n).hasClass("home")){$(".selecionador").css("left",a);var o=$(n).children().children().attr("src").replace("ico.png","ico-sel.png");$(n).children().children().attr("src",o),n.classList.add("selecionado")}}(s),t&&t()}).fail(function(){alert("Sorry but there was an error: "+xhr.status+" "+xhr.statusText)})}appInCell=window.innerHeight>window.innerWidth;var e,i;$("aside.menu-area .menu a").on("mouseout",function(){if(!$(this).hasClass("selecionado")){var e=$(this).children().children(),n=$(e).attr("src").split("-sel").join("");$(e).attr("src",n)}}),$("aside.menu-area .menu a").on("mouseover",function(){if(!$(this).hasClass("selecionado")){var e=$(this).children().children(),n=$(e).attr("src").split(".");if(!(-1<$(e).attr("src").indexOf("-sel"))){n[0]=n[0]+"-sel";var i=n.join(".");$(e).attr("src",i)}}}),function(){var e=$(document).height(),n=100*e/800*1280/100;if(appInCell)return $("#wrapperHeader").css("width",$(document).width()),$(".conteudo").css("width",$(document).width());$(".fixArea").height(e),$(".fixArea").width(n),$("#wrapperHeader").width(n)}(),window.onhashchange=function(e){return n(locHash)},$.each($("a.home, nav.menu a"),function(e,n){$(n).on("click",function(){var e=$(this).attr("nav-link-mob");locHash=appInCell&&e?(n.href="#"+$(this).attr("nav-link-mob"),$(this).attr("nav-link-mob")):(n.href="#"+$(this).attr("nav-link"),$(this).attr("nav-link"))})}),e=window.location.href,0<(i=e.indexOf("#"))&&(window.location=e.substring(0,i)),n("paginas/home.html",function(){$("#splashScreen img").fadeIn(),setTimeout(function(){$("#splashScreen").fadeOut()},3e3)})}();
