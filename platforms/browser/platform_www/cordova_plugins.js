...
module.exports = [
    ...
    {
        "file": "plugins/cordova-plugin-local-notifications-npm/www/local-notification.js",
        "id": "cordova-plugin-local-notifications-npm.LocalNotification",
        "pluginId": "cordova-plugin-local-notifications-npm",
        "clobbers": [
    ...
    {
        "file": "plugins/cordova-plugin-local-notifications-npm/www/local-notification-core.js",
        "id": "cordova-plugin-local-notifications-npm.LocalNotification.Core",
        "pluginId": "cordova-plugin-local-notifications-npm",
        "clobbers": [
    ...
    {
        "file": "plugins/cordova-plugin-local-notifications-npm/www/local-notification-util.js",
        "id": "cordova-plugin-local-notifications-npm.LocalNotification.Util",
        "pluginId": "cordova-plugin-local-notifications-npm",
        "merges": [
            "cordova.plugins.notification.local.core",
            "plugin.notification.local.core"
...
// TOP OF METADATA
{
    ...
    "cordova-plugin-local-notifications-npm": "1.0.3",
